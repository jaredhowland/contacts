 ...
 */
class Vcard4 implements ContactsInterface
{
    use Helpers\Generic;
    use Helpers\Vcard;
     ...
     */
    public function addFullName(string $name): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addNickname(string $name): Vcard4
    {
     ...
     */
    public function addPhoto(string $photo, bool $isUrl = true): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addBirthday(int $month, int $day, ?int $year = null): Vcard4
    {
        if ($year === null) {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addLabel(string $label, array $types = []): Vcard4
    {
        // Make sure all `$types`s are valid. If invalid `$types`(s), revert to standard default.
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addTelephone(string $phone = null, array $types = []): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addEmail(string $email = null, array $types = null): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addMailer(string $mailer): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addTimeZone(string $timeZone): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addLatLong(float $lat, float $long): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addTitle(string $title): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addRole(string $role): Vcard4
    {
     ...
     */
    public function addLogo(string $logo, bool $isUrl = true): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addOrganizations(array $organizations): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addCategories(array $categories): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addNote(string $note): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addProductId(string $productId): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addRevision(string $dateTime = null): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addSortString(string $sortString): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addUniqueIdentifier(string $uniqueIdentifier = null): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addUrl(string $url): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addClassification(string $classification = 'PUBLIC'): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addExtendedType(string $label, string $value): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addAnniversary(string $anniversary): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addSupervisor(string $supervisor): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addSpouse(string $spouse): Vcard4
    {
     ...
     * @throws ContactsException if an element that can only be defined once is defined more than once
     */
    public function addChild(string $child): Vcard4
    {
